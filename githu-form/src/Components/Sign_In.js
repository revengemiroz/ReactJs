...
const A = styled.a`
    ...
    line-height: 21px;
    font-weight:${props => props.createandaccount ? '400' : '600'};
        ...
        <div>
            {isBollean ? (
                ...
                <SignInDiv className='SignIn'>
                    ...
                    <form onSubmit={handleSubmit(() => {
                        ...
                        <Div>
                            <InputContainer>
                                ...
                                <Input id='username' type='text' ref={register}></Input>
                            </InputContainer>

                            <div>
                                <LabelContainer>
                                    <Label htmlFor='password'>Password</Label>
                                    <A forgot>Forgot password?</A>
                                </LabelContainer>
                    ...
                    <New>
                        <p>New to Github? <A createandaccount>Create and account.</A></p>
                    </New>
